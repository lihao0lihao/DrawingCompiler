...
def unzip_files(json_data, download_path):
    # json_data['sequences']=json.loads(json_data['sequences'])
...
if __name__ == "__main__":
    root='E:\\VOT-Dataset-Download-master'
    destination_path = root+'\\vot_lt2018\\'    # destination path
    json_path = root+'\\description.json'      # vot 2019 json file
    anno_vot = 'vot2018/longterm'         # vot2019 or vot2018 or vot2017
    download_path = root+'\\vot_lt2018-1\\'       # download path, use to extract downloaded file
    ...
    print("sss")
    unzip_files(json_data, download_path)    # unzip files downloaded
    # config